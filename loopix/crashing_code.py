...
if __name__ == "__main__":
	...
	def add_to_queue():
		print "Adding to the queue. Current queue size: %d" % len(processQueue.queue)
#		global setup
#		global client
#		global provider
	...
	def process_queue(x):
		...
		try:
			...
			print "ERROR: Message reading error: ", str(e)

		reactor.callFromThread(processQueue.get().addCallback, process_queue)



#	readMessage(client, msg2, addr)
#	client.processQueue.get()
	#processQueue.get().addCallback(readMessage)
